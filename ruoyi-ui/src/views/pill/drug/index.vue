<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="drugList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="生产厂家" align="center" prop="pillFactory.factoryName" min-width="200"/>
      ...
      <el-table-column label="处方类型" align="center" prop="drugType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.pill_drug_ds" :value="scope.row.prescriptionType"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px"  append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="药品类型">
          <el-select v-model="form.drugType" placeholder="请输入药品">
            <el-option
        ...
        <el-form-item label="处方类型">
          <el-select v-model="form.prescriptionType" placeholder="请输入处方">
            <el-option
              v-for="dict in dict.type.pill_drug_ds"
              :key="dict.value"
              :label="dict.label"
              :value="dict.value"
            />
...
export default {
  name: "Drug",
  dicts: ['pill_drug_dt', 'pill_drug_ds', 'sys_normal_disable'],
  data() {
    return {
      // 遮罩层
      loading: true,
